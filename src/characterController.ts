...
export class Player {//extends TransformNode {
    ...
    constructor(assets, scene: Scene, shadowGenerator: ShadowGenerator, input) {
        ...
        this.hitBox.physicsImpostor = new PhysicsImpostor(this.hitBox, PhysicsImpostor.BoxImpostor, { mass: 0, friction: 1, restitution: 1, disableBidirectionalTransformation: false }, scene);
